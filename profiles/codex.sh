...
# protocol: bin/gang distinguishes failure from a bad level by EMPTY OUTPUT, and
# its `set -e` would otherwise exit before it could name the broken declaration.
