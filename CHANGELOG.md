...
## [0.5.0](https://github.com/adambiggs/gangline/compare/gangline-v0.4.0...gangline-v0.5.0) (2026-08-04)
...
* **compact:** a resume is charged to the context it is renewing ([da9425f](https://github.com/adambiggs/gangline/commit/da9425f2a632d373f11bc71debb3e30a5eefa6c8))
...
* **cycle:** a predecessor is retired, not killed ([da59f99](https://github.com/adambiggs/gangline/commit/da59f9988bed9eb9e92b66b1d0e8a03432d6eae5))
* **cycle:** a renewal may name the model its replacement runs on ([4dfb7d9](https://github.com/adambiggs/gangline/commit/4dfb7d901ab2a6dbdc4a6f78e607ff27286b167c))
* **cycle:** a renewal that carries nothing is one nobody can use ([6671d4b](https://github.com/adambiggs/gangline/commit/6671d4b56f29427fcd9444157153c6e4b5fca5dd))
* **cycle:** a renewed agent belongs where the one it replaced was ([15ce194](https://github.com/adambiggs/gangline/commit/15ce19471c74e9a7492ec92c2f00114b91b649e6))
* **cycle:** renew an agent by replacing it, on its recorded facts ([008e776](https://github.com/adambiggs/gangline/commit/008e7769f8b5bdb9978e8b875d1a01ce08902840))
* **cycle:** the session's only agent can be renewed ([ff1545b](https://github.com/adambiggs/gangline/commit/ff1545b8d34eccb143212f5aa26bd0f6c352d7cd))
* enforce reviewed structured continuation state ([de8bf57](https://github.com/adambiggs/gangline/commit/de8bf577ae6cb80a9618cba13231e918120c0e3a))
* **hitch:** an agent may be launched at the reasoning effort its profile spells ([ef9d878](https://github.com/adambiggs/gangline/commit/ef9d87841089a1be1064bc744c2f944d23a5b089))
...
* **profiles:** validate codex effort levels ([05eafc1](https://github.com/adambiggs/gangline/commit/05eafc19e86e5674311e9f95ad1183d2d36a7551))
* **profiles:** wire codex lifecycle hooks ([d60d509](https://github.com/adambiggs/gangline/commit/d60d5090d44bb2cb90676f0df072a730bda7b480))
...
* **record:** a launch fact is named where it is written ([9357e4b](https://github.com/adambiggs/gangline/commit/9357e4b908c907f158fe2e062b3eca069663e390))
* **roles:** a low rung is information, not an instruction ([d9b57e6](https://github.com/adambiggs/gangline/commit/d9b57e6297aa5c7981cf16868f28c590b5d57116))
* **roles:** renewal is a cycle, and the agent survives it ([71f835e](https://github.com/adambiggs/gangline/commit/71f835ec02a3c58fb1282a47a14813db79fe6b7c))
...
* **bands:** the first rung is an onset, and the note now names a verb that works ([e09ac71](https://github.com/adambiggs/gangline/commit/e09ac71e4bd0f03b5a52042ee43b8059b2bb6296))
...
* **cycle:** the spent window is put at the end rather than found there ([d3ef377](https://github.com/adambiggs/gangline/commit/d3ef3776f7fe7de118294761286943bcd95d0c9a))
* **hitch:** stop advertising native compaction in role briefs ([b5ab14e](https://github.com/adambiggs/gangline/commit/b5ab14e74b79bac1d8e5218f2a0acc730b422827))
* leave context renewal to gangline ([1b367a8](https://github.com/adambiggs/gangline/commit/1b367a88ddfae1cef86b901c8231ebaf74ce0080))
...
* **profiles:** claude-code renewed on a schedule nothing chose ([a98b541](https://github.com/adambiggs/gangline/commit/a98b54195f20a108332c84aacfa8f20044e47845))
...
* **test:** a producer that stops only on SIGPIPE is not bounded ([6036e5a](https://github.com/adambiggs/gangline/commit/6036e5a071ffc273c711852ff24a64eab2caeae2))
...
* **test:** the budget checks left their own resumes in flight ([e865e94](https://github.com/adambiggs/gangline/commit/e865e94f12493b02cc9a3cf471f5d6896cc5e4b7))
